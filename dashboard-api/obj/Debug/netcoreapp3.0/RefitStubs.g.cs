...
namespace dashboardAPI.Clients
{
    ...
    [Preserve]
    [global::System.Reflection.Obfuscation(Exclude=true)]
    partial class AutoGeneratedGameClient : GameClient
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly IRequestBuilder requestBuilder;
        ...
        /// <inheritdoc />
        public AutoGeneratedGameClient(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
        ...
        /// <inheritdoc />
        Task<string> GameClient.GetGameAsync(string authorization, long matchId)
        {
...
namespace dashboardAPI.Clients
{
    ...
    [Preserve]
    [global::System.Reflection.Obfuscation(Exclude=true)]
    partial class AutoGeneratedHistoryClient : HistoryClient
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly IRequestBuilder requestBuilder;
        ...
        /// <inheritdoc />
        public AutoGeneratedHistoryClient(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
        ...
        /// <inheritdoc />
        Task<string> HistoryClient.GetListHistoryAsync(string authorization, string encryptedAccountId)
        {
        ...
        /// <inheritdoc />
        Task<string> HistoryClient.GetListHistoryByChampAsync(string authorization, string encryptedAccountId, int endIndex)
        {
