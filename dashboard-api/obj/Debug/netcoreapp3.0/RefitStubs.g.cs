...
namespace dashboardAPI.Clients
{
    ...
    partial class AutoGeneratedAccountClient : AccountClient
    {
        ...
        /// <inheritdoc />
        Task<string> AccountClient.GetAccountByNameAsync(string authorization, string summonerName)
        {
            var arguments = new object[] { authorization, summonerName };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetAccountByNameAsync", new Type[] { typeof(string), typeof(string) });
            return (Task<string>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<string> AccountClient.GetAccountByPuuidAsync(string authorization, string encryptedPUUID)
        {
            var arguments = new object[] { authorization, encryptedPUUID };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetAccountByPuuidAsync", new Type[] { typeof(string), typeof(string) });
            return (Task<string>)func(Client, arguments);
        }
    }
}
...
namespace dashboardAPI.Clients
{
    ...
    [Preserve]
    [global::System.Reflection.Obfuscation(Exclude=true)]
    partial class AutoGeneratedCDragonClient : CDragonClient
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly IRequestBuilder requestBuilder;
        ...
        /// <inheritdoc />
        public AutoGeneratedCDragonClient(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
        ...
        /// <inheritdoc />
        Task<string> CDragonClient.GetAllCampanionsAsync()
        {
            var arguments = new object[] {  };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetAllCampanionsAsync", new Type[] {  });
            return (Task<string>)func(Client, arguments);
        }
    }
}
...
namespace dashboardAPI.Clients
{
    ...
    partial class AutoGeneratedTftClient : TftClient
    {
        ...
        /// <inheritdoc />
        Task<string> TftClient.GetGameAsync(string authorization, string matchId)
        {
            var arguments = new object[] { authorization, matchId };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetGameAsync", new Type[] { typeof(string), typeof(string) });
            return (Task<string>)func(Client, arguments);
        }
    }
}
